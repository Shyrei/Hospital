		...
		<div class="row">
			<div class="col-md-7 col-md-offset-2">
				<div class="text-center">
					<h3><fmt:message key="title.add.doctor" /></h3>
				</div>
				<form action="controller" method="POST" class="form-horizontal">
					<div class="form-group">
						<label for="name" class="col-sm-3 control-label"><fmt:message key="add.doctor.name" /></label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						<label for="specialization" class="col-sm-3 control-label"><fmt:message key="add.doctor.specialization" /></label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						<label for="Departments_id" class="col-sm-3 control-label"><fmt:message key="add.doctor.department" /></label>
						<div class="col-sm-9">
							<input name="Departments_id" id="Departments_id" type="text" class="form-control"
								placeholder="<fmt:message key="add.doctor.department.placeholder" />">
						</div>
					</div>
					<div class="text-right">
						<input type="hidden" name="command" value="add_doctor">
						<button type="submit" class="btn btn-primary"><fmt:message key="button.add.doctor" /></button>
					</div>
					<br>
				</form>
			</div>
