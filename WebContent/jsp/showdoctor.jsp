...
<body>
	<div class="container">
		<div class="row">
			...
			<h3><fmt:message key="title.show.all.doctors" /></h3>
			</div>
				...
				<table class="table table-striped table-condensed table-bordered">
					<tr>
						...
						<td align="center"><fmt:message key="show.doctor.specialization" /></td>
					...
					<c:forEach items="${list}" varStatus="сounter">
						<tr>
							...
							<td align="center">${list[сounter.count-1].specialization}</td>
							<td align="center">${list[сounter.count-1].depId}</td>
						</tr>
					</c:forEach>
				</table>
			</div>
